...
class Scraper:
    ...
    def scrape(self):
        ...
        for url in self.urls:
            ...
            json_dict = json.loads(soup.find('script', {'id': '__NEXT_DATA__'}).contents[0])['props']['pageProps']['initialMenuState']
            ...
            self.restaurant_data.append([restaurant_name, restaurant_logo, latitude, longitude, cuisine_tags, menu_items])
        self.pretty_print()    
